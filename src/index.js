...
var questions = [
    ...
    {
        "what is Toby's daughters name?": [
            "sasha"

        ]
    },
    {
        "Who fills in for Toby when he is away for Jury Duty?": [
            "holly"
        ]
    },
    {
        "In Diversity Day what ethnicity did Kevin have on his head?": [
            "italian"
        ]
    },
    {
    ...
    {
        "What color purse does Dwight buy in hot girl?": [
            "black"
        ]
    },
    {
    ...
    {
        "What is the name of Michael's realtor, who is also his one time girlfriend?": [
            "carol"
        ]
    },
    {
...
var CARD_TITLE = "The Office Trivia";
...
function getWelcomeResponse(callback) {
    ...
    var sessionAttributes = {},
        ...
        speechOutput = "I will ask you " + GAME_LENGTH.toString()
            + " questions about The Office, try to get as many right as you can. Just say the answer. Let's begin. ",
...
function handleFinishSessionRequest(intent, session, callback) {
    ...
    callback(session.attributes,
        buildSpeechletResponseWithoutCard("Thanks for playing the Office Trivia!", "", true));
}
